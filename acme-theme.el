...
;;;;; dired/diredfl/dired-subtree
   `(dired-directory                              ((t (:foreground ,acme-blue :weight bold))))
   `(diredfl-display-msg                          ((t (:foreground ,acme-blue))))
   `(diredfl-compressed-file-suffix               ((t (:foreground ,acme-purple))))
   `(diredfl-date-time                            ((t (:foreground ,acme-green))))
   `(diredfl-deletion                             ((t (:foreground ,acme-red))))
   `(diredfl-deletion-file-name                   ((t (:foreground ,acme-red))))
   `(diredfl-dir-heading                          ((t (:foreground ,acme-blue :background ,acme-blue-light :weight bold))))
   `(diredfl-dir-priv                             ((t (:foreground ,acme-blue))))
   `(diredfl-exec-priv                            ((t (:foreground ,acme-yellow))))
   `(diredfl-executable-tag                       ((t (:foreground ,acme-yellow))))
   `(diredfl-file-name                            ((t (:foreground ,fg))))
   `(diredfl-file-suffix                          ((t (:foreground ,acme-yellow))))
   `(diredfl-flag-mark                            ((t (:foreground ,acme-cyan))))
   `(diredfl-flag-mark-line                       ((t (:foreground ,acme-cyan))))
   `(diredfl-ignored-file-name                    ((t (:foreground ,fg-light))))
   `(diredfl-link-priv                            ((t (:foreground ,acme-purple))))
   `(diredfl-mode-line-flagged                    ((t (:foreground ,acme-yellow))))
   `(diredfl-mode-line-marked                     ((t (:foreground ,acme-yellow))))
   `(diredfl-no-priv                              ((t (:foreground ,fg))))
   `(diredfl-number                               ((t (:foreground ,acme-blue))))
   `(diredfl-other-priv                           ((t (:foreground ,fg))))
   `(diredfl-rare-priv                            ((t (:foreground ,fg))))
   `(diredfl-read-priv                            ((t (:foreground ,fg))))
   `(diredfl-symlink                              ((t (:foreground ,fg :background ,acme-blue-light))))
   `(diredfl-write-priv                           ((t (:foreground ,fg))))
   `(diredfl-dir-name                             ((t (:foreground ,acme-blue :weight bold))))
...
;;;;; Org
   ...
   `(org-todo                                     ((t (:foreground ,acme-yellow :weight bold :box nil))))
   `(org-done                                     ((t (:foreground ,acme-green :weight bold :box nil))))
